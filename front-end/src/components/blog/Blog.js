        ...
        <div className="row">
          <div className="col-sm-12">
            <div className="title-box text-center">
              <h3 className="title-a text-white">
                Blog
              </h3>
          ...
          <div className="col-md-4">
            <div className="card card-blog">
              <div className="card-img">
                <a href="blog-single.html"><img src="/img/post-2.jpg"  className="img-fluid" /></a>
              </div>
              ...
              <div className="card-footer">
                <div className="post-author">
                  <a href="#">
                    <img src="/img/testimonial-1.jpg" alt className="avatar rounded-circle" />
